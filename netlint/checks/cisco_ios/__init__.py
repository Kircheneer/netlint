...
@checker_instance.register(apply_to=["cisco_ios"], name="IOS101")
...
@checker_instance.register(apply_to=["cisco_ios"], name="IOS102")
...
@checker_instance.register(apply_to=["cisco_ios"], name="IOS103")
